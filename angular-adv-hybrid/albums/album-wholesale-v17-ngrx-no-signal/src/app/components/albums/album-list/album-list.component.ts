...
@Component({
    ...
    standalone: true,
    imports: [MatCard, MatCardHeader, MatCardTitle, MatCardSubtitle, MatCardImage, MatCardContent, MatChipSet, MatChip, MatCardActions, MatButton, AsyncPipe, SlicePipe]
})
