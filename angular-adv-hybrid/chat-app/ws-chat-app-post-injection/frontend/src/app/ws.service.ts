...
export class WsService {
  ...
  private connect() {
    ...
    console.log('Connecting to channel:', this.channel, this._username);
  ...
  sendMessage(message: string) {
    console.log({type: 'send',uuid: this.uuidValue, text: message, username: this.username, channel: this.channel})
